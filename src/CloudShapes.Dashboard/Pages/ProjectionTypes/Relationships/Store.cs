...
/// <param name="monacoEditorHelper">The service used to to facilitate the Monaco Relationships configuration</param>
/// <param name="jsonSerializer">The service used to serialize/deserialize data to/from JSON</param>
/// <param name="yamlSerializer">The service used to serialize/deserialize data to/from YAML</param>
public class ProjectionTypeRelationshipsStore(ILogger<ProjectionTypeRelationshipsStore> logger, ICloudShapesApiClient cloudShapesApi, IMonacoEditorHelper monacoEditorHelper, IJsonSerializer jsonSerializer, IYamlSerializer yamlSerializer)
    : ComponentStore<ProjectionTypeRelationshipsState>(new())
{
    #region Selectors
    /// <summary>
    /// Gets an <see cref="IObservable{T}"/> used to observe <see cref="ProjectionTypeRelationshipsState.Status"/> changes
    /// </summary>
    public IObservable<string> Status => this.Select(state => state.Status).DistinctUntilChanged();

    /// <summary>
    /// Gets an <see cref="IObservable{T}"/> used to observe <see cref="ProjectionTypeRelationshipsState.ProjectionTypeName"/> changes
    /// </summary>
    public IObservable<string?> ProjectionTypeName => this.Select(state => state.ProjectionTypeName).DistinctUntilChanged();

    /// <summary>
    /// Gets an <see cref="IObservable{T}"/> used to observe <see cref="ProjectionTypeRelationshipsState.ProjectionType"/> changes
    /// </summary>
    ...
    #region Setters
    /// <summary>
    /// Sets the state's <see cref="ProjectionTypeRelationshipsState.ProjectionType"/>
    /// </summary>
    ...
    /// <summary>
    /// Sets the state's <see cref="ProjectionTypeRelationshipsState.ProjectionTypeName"/>
    /// </summary>
